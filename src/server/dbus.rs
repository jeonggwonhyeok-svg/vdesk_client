...
///
/// Note:
/// On linux, we use dbus to communicate multiple onedesk process.
...
const DBUS_NAME: &str = "org.onedesk.onedesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "OneDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.onedesk.onedesk /dbus org.onedesk.onedesk.NewConnection string:'PEER_ID'`
