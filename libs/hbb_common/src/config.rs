...
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("onedesk docs home", LINK_DOCS_HOME),
        ("onedesk docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("onedesk x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["turn.tohocoin.com"];
pub const RS_PUB_KEY: &str = "mzcXkqIjQIqRoukKv3JOIBvLGqPLKdIpH4DkFILnxOo=";
...
pub mod keys {
    ...
    pub const OPTION_VIDEO_SAVE_DIRECTORY_INCOMING: &str = "video-save-directory-incoming";
    pub const OPTION_VIDEO_SAVE_DIRECTORY_OUTGOING: &str = "video-save-directory-outgoing";
    pub const OPTION_SCREENSHOT_SAVE_DIRECTORY: &str = "screenshot-save-directory";
    ...
    pub const KEYS_LOCAL_SETTINGS: &[&str] = &[
        ...
        OPTION_SCREENSHOT_SAVE_DIRECTORY,
